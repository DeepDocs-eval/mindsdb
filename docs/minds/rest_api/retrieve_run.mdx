...
run = client.beta.threads.runs.retrieve("thread_abc123", "mdb_run_8b425f3bf0a04ca584ad11106d37330c")
print(run)
```
...
async function main() {
  const run = await openai.beta.threads.runs.retrieve("thread_abc123", "mdb_run_8b425f3bf0a04ca584ad11106d37330c");
}
