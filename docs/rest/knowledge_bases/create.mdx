...
<ParamField body='knowledge_base.name' type='string' required>
Name of the knowledge base.
</ParamField>

<ParamField body='knowledge_base.storage' type='object'>
Underlying vector database that stores the embeddings.
</ParamField>

<ParamField body='knowledge_base.embedding_model' type='object'>
