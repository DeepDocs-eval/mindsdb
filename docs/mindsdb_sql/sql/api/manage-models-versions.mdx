...
+------------+------------+-------+------+-------+--------+--------+------------+-------------+---------------+------+------------------------------------+---------------------------------------+----------------------+---------------------+------+--------------------------+-------------+
|home_rentals|my_ml_engine|mindsdb|true  |1      |complete|0.999   |rental_price|up_to_date   |22.11.3.2      |[NULL]|SELECT * FROM demo_data.home_rentals|{"target": "rental_price", "using": {"engine": "my_ml_engine", "tag": "my model"}}|5                     |5                    |my model|2024-02-07 16:01:04.990958|19.946       |
+------------+------------+-------+------+-------+--------+--------+------------+-------------+---------------+------+------------------------------------+---------------------------------------+----------------------+---------------------+------+--------------------------+-------------+
```
